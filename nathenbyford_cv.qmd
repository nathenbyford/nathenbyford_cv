...
cvmeta:
  ...
  - title: Techs
    left: R, bash, Python, Regression, Machine Learning
...
tibble::tribble(
    ...
    "Capstone project (Planarian Growth)", "Baylor University", "May 2022", c("Worked with freshmen in BIO 1406 class as statistical consultant", "Analyzed the growth of planarian based on light exposure", "Guided students from experimental design through to presentation of results"),
